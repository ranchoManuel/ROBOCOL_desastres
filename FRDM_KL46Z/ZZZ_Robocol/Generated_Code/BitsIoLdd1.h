...
#define BitsIoLdd1_MODULE_BASE_ADDRESS FPTD_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd1_PORTCONTROL_BASE_ADDRESS PORTD_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd1_PORT_MASK 0x78U     /*!< Mask of the allocated pin from the port */
...
#define BitsIoLdd1_PIN_ALLOC_0_MASK 0x08 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd1_PIN_ALLOC_0_INDEX 3U /*!< The index of the first allocated pin from the port */
