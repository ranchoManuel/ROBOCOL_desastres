...
static ComGalileo_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
/* {Default RTOS Adapter} Global variable used for passing a parameter into ISR */
static ComGalileo_TDeviceDataPtr INT_UART0__DEFAULT_RTOS_ISRPARAM;
...
LDD_TDeviceData* ComGalileo_Init(LDD_TUserData *UserDataPtr)
{
  ...
  ComGalileo_TDeviceDataPtr DeviceDataPrv;
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_ComGalileo_ID,DeviceDataPrv);
...
{
  ComGalileo_TDeviceDataPtr DeviceDataPrv = (ComGalileo_TDeviceDataPtr)DeviceDataPtr;
...
** ===================================================================
*/
static void InterruptRx(ComGalileo_TDeviceDataPtr DeviceDataPrv)
{
  ...
  if (DeviceDataPrv->InpDataNumReq != 0x00U) { /* Is the receive block operation pending? */
    *(DeviceDataPrv->InpDataPtr++) = (uint8_t)Data; /* Put an 8-bit character to the receive buffer */
    ...
    if (DeviceDataPrv->InpRecvDataNum == DeviceDataPrv->InpDataNumReq) { /* Is the requested number of characters received? */
      ...
      ComGalileo_OnBlockReceived(DeviceDataPrv->UserDataPtr);
    }
  }
}
...
** ===================================================================
*/
static void InterruptTx(ComGalileo_TDeviceDataPtr DeviceDataPrv)
{
  ...
  if (DeviceDataPrv->OutSentDataNum < DeviceDataPrv->OutDataNumReq) { /* Is number of sent characters less than the number of requested incoming characters? */
    ...
    if (DeviceDataPrv->OutSentDataNum == DeviceDataPrv->OutDataNumReq) {
      DeviceDataPrv->OutDataNumReq = 0x00U; /* Clear the counter of characters to be send by SendBlock() */
      ComGalileo_OnBlockSent(DeviceDataPrv->UserDataPtr);
    }
  } else {
...
PE_ISR(ComGalileo_Interrupt)
{
  ...
  ComGalileo_TDeviceDataPtr DeviceDataPrv = INT_UART0__DEFAULT_RTOS_ISRPARAM;
